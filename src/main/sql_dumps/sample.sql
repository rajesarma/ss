...
--
-- Name: recruitment_entity; Type: TABLE; Schema: public; Owner: sample; Tablespace: 
--

CREATE TABLE recruitment_entity (
    ...
    alternate_no character varying(255),
    dob date,
    email_notification_active character(1),
    ...
    sms_notification_active character(1),
    stage integer
);
...
--
-- Name: recruitment_recruiter; Type: TABLE; Schema: public; Owner: sample; Tablespace: 
--

CREATE TABLE recruitment_recruiter (
    id integer NOT NULL,
...
ALTER TABLE public.recruitment_recruiter OWNER TO sample;

--
-- Name: recruitment_recruiter_id_seq; Type: SEQUENCE; Schema: public; Owner: sample
--

CREATE SEQUENCE recruitment_recruiter_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.recruitment_recruiter_id_seq OWNER TO sample;

--
-- Name: recruitment_recruiter_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: sample
--

ALTER SEQUENCE recruitment_recruiter_id_seq OWNED BY recruitment_recruiter.id;
...
ALTER TABLE ONLY recruitment_recruiter ALTER COLUMN id SET DEFAULT nextval('recruitment_recruiter_id_seq'::regclass);
...
--
-- Data for Name: recruitment_entity; Type: TABLE DATA; Schema: public; Owner: sample
--

COPY recruitment_entity (dtype, id, address, created_on, email, first_name, is_active, last_login, last_name, mobile, postal_code, updated_on, company_name, user_id, aadhar, alternate_no, dob, email_notification_active, father_name, gender, marital_status, photo, photo_name, resume, resume_name, sms_notification_active, stage) FROM stdin;
\.
...
--
-- Data for Name: recruitment_recruiter; Type: TABLE DATA; Schema: public; Owner: sample
--
...
--
-- Name: recruitment_recruiter_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sample
--

SELECT pg_catalog.setval('recruitment_recruiter_id_seq', 1, false);
...
3	SAMPLE000003	Lakshmi Rajeswara Rao	A	2021-12-07 22:24:49.871	M	9866489944	9944994499	dd@dd.com	Test	1982-08-01	\N	\N	Seeta Rama Prasad	\N	2021-12-07 22:24:49.871	2021-12-07 22:24:49.871	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	442323232333		A	A	\N	0	\N
4	SAMPLE000004	Lakshmi Rajeswara Rao	A	2021-12-07 22:29:02.446	M	9866489944	9944994499	dd@dd.com	Test	1982-08-01	\N	\N	Seeta Rama Prasad	\N	2021-12-07 22:29:02.446	2021-12-07 22:29:02.446	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	442323232333		A	A	\N	0	\N
...
--
-- Name: recruitment_entity_pkey; Type: CONSTRAINT; Schema: public; Owner: sample; Tablespace: 
--
...
--
-- Name: recruitment_recruiter_pkey; Type: CONSTRAINT; Schema: public; Owner: sample; Tablespace: 
--

ALTER TABLE ONLY recruitment_recruiter
    ADD CONSTRAINT recruitment_recruiter_pkey PRIMARY KEY (user_id);
...
--
-- Name: uk_1h3n0g7ripnxdhwsngyn9ey2i; Type: CONSTRAINT; Schema: public; Owner: sample; Tablespace: 
--

ALTER TABLE ONLY recruitment_recruiter
    ADD CONSTRAINT uk_1h3n0g7ripnxdhwsngyn9ey2i UNIQUE (user_id);
...
--
-- Name: uk_2p58q79orgi24sb02881cvesq; Type: CONSTRAINT; Schema: public; Owner: sample; Tablespace: 
--

ALTER TABLE ONLY recruitment_entity
    ADD CONSTRAINT uk_2p58q79orgi24sb02881cvesq UNIQUE (user_id);
